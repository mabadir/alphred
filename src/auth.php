...
if(isset($username) && isset($password) ):
	...
	$query='client_id=<client_password_secret>&password_grant_secret=e4t3JLjUwMptYvusGvzL4Bp95L3PbGbp&grant_type=password&username='.$username.'&password='.$password.'&scope=stream write_post follow messages';
	connect($url,$query,$w);
else:
